CreateThread(function()
    ...
    local docs_link = 'https://docs.codesign.pro/free-scripts/devtools#changelog'
    local download_link = 'https://keymaster.fivem.net/asset-grants'
    PerformHttpRequest('https://raw.githubusercontent.com/RampBST/Codesign_Versions_V2/master/cd_devtools.txt',function(error, result, headers)
